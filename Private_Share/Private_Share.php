      ...
      <div class = "panel-body pbody">
        ...
        $connection_String = mysqli_connect($host,$user,$pass,$database);
          ...
          while($fetch_each_user=mysqli_fetch_array($fetch_users)){ 
            ...
            echo "<span style='float:right;margin-top:-22px;margin-right:5px'><img style='cursor:pointer' id='$counter' name='$fullname' class='item_number_clicker' src='../img/plus_sign.png' alt='Image' width='25px' height='25px'/></span>";
